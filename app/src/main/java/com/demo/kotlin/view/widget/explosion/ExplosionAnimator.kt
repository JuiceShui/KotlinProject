...
class ExplosionAnimator(container: View, bitmap: Bitmap, bound: Rect?) :
    ...
    companion object {
        ...
        private val DEFAULT_INTERPOLATOR: AccelerateInterpolator = AccelerateInterpolator(0.6f)
        private const val END_VALUE = 1.4f
        private val X: Float = Tools.dp2Px(5).toFloat()
        private val Y: Float = Tools.dp2Px(20).toFloat()
        private val V: Float = Tools.dp2Px(2).toFloat()
        private val W: Float = Tools.dp2Px(1).toFloat()
    }
